...
public class MainActivity extends AppCompatActivity
    ...
    class MySessionOptions extends Session.SessionOptions {
    ...
    private void initializeSession(String apiKey, String sessionId, String token) {
        ...
        final Session.Builder builder = new Session.Builder(this, apiKey, sessionId);
        builder.sessionOptions(new MySessionOptions());
